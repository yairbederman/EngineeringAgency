...
3. **If found**: Load as primary configuration source → Proceed to Step 1
4. **If NOT found**: 
   ...
   **⛔ DO NOT proceed to Step 1 or any other step. WAIT for user response.**
...
1. **Read**: `agent-config.md` (detected above — Workspace settings, projects, Atlassian)
2. **Read**: `${SYSTEM_ARCH_ROOT}/configuration.md` (Agent-specific paths)
